...
namespace Auth.Controllers
{
    ...
    public class WalletsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("WalletIdentifier")] Wallet wallet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,WalletIdentifier,Balance")] Wallet wallet)
        {
            if (id != wallet.Id)
            {
                return NotFound();
